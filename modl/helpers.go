package modl // [TODO: eventually, the package name needs to be replaced with something more meaningful.]
...
type ActivityLog2 struct { // added additional fields related to icons
	ActivityLog
	MdlIconCode string
	IsGroup     bool
}
...
func ActivityGetIconsData() (a []MdlIcons) { // [TODO: eventually store this in datastore and retrieve from there, instead of ha]
	a = []MdlIcons{
...
func ActivityGet(c appengine.Context, filters []Filter, orderBy string) []ActivityLog { //[TODO: need to return error]
	parentKey := GetActivityTableKeyByUser(c)
	recSet := []ActivityLog{}
...
func ActivityInsert(c appengine.Context, rec ActivityLog) (err error) {
...
//
func ActivityUpdate(c appengine.Context, ActivityName string, SubTask string, StartTime string, Status string, NewStatus string) (err error) {
