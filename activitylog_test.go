...
func testActivityLog(t *testing.T, c context.Context, h http.Handler) {
	...
	tcs = append(tcs, tc)
	tc.Name = "Activity Log Post with typo in field name in json/Sending Extra field"
	...
	tcs = append(tcs, tc)
	tc.Name = "Activity Log Put with typo in field name in json/Sending Extra field"
